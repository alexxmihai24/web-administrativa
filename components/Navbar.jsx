                        ...
                        <div className="flex items-center space-x-6">
                            ...
                            <div className="hidden md:flex items-center space-x-4">
                                ...
                                <button
                                    ...
                                    className="bg-yellow-400 text-blue-900 hover:bg-yellow-300 font-bold transition-all duration-300 hover:scale-105 px-4 py-2 rounded-lg shadow-lg hover:shadow-yellow-400/50 flex items-center space-x-2"
                                >
